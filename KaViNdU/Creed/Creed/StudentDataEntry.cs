...
namespace Creed
{
    public partial class StudentDataEntry : Form
    {
        ...
        {
            if (NameTXT.Text == "" || DTPicker.Text == "" || MaleB.Text == "" || FemaleB.Text == "")
            {
        ...
        {
            if (System.Text.RegularExpressions.Regex.IsMatch(IndexTXT.Text, "[^0-9]"))
            {
        ...
        private void SaveBT_Click(object sender, EventArgs e)
        {
            if (System.Text.RegularExpressions.Regex.IsMatch(IndexTXT.Text, "[^0-9]"))
            {
                ...
                if (IndexTXT.Text == "" || NameTXT.Text == "" || DTPicker.Text == "" || MaleB.Text == "" || FemaleB.Text == "")
                {
                    MessageBox.Show("Fill all the fields !");
                }
                else {
